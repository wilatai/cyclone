# -*- test-case-name: cyclone.tw.test.test_newclient -*-
...
from cyclone.tw.iweb import UNKNOWN_LENGTH
from cyclone.tw.http_headers import Headers
from cyclone.tw.http import NO_CONTENT, NOT_MODIFIED
from cyclone.tw.http import _DataLoss, PotentialDataLoss
from cyclone.tw.http import _IdentityTransferDecoder, _ChunkedTransferDecoder
...
class Request:
    ...
    @type headers: L{cyclone.tw.http_headers.Headers}
